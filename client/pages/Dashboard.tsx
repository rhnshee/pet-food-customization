        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <Button
                size="sm"
                className="bg-white text-blue-500 hover:bg-gray-100 text-xs px-3 py-1 rounded-full"
              >
                DOG
              </Button>
              <Button
        ...
        {isMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-lg border-t border-orange-200 z-50">
            ...
            <nav className="py-2">
              <a
                href="#"
                className="flex items-center gap-3 px-6 py-3 text-blue-600 bg-blue-50 font-medium"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
